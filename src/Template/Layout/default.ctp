<?php
$cakeDescription = 'Photos Fred Radeff';
...
du -sh ./
largeur=800
find ./ -type f -size +900k -name "*.JPG" -o -name "*.jpg" | while read i
do
	mogrify -resize $largeur "$i"
done
poids=`du -sh ./`
echo "Fini! Le répertoire " $chemin " pèse maintenant " $poids
* */
...
<div id="container">
    ...
    <header>
    <h1><a href="<?php echo CHEMIN; ?>">Photos Fred Radeff&nbsp;&nbsp;<img src="/pics/photos/app_photo_russe.jpg" alt="Photos Fred Radeff - home"/></a><a href="<? echo CHEMIN; ?>photos/rss"><img src="/pics/rss.png" alt="Flux RSS"></a></h1>
